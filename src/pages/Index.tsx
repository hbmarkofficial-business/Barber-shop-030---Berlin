  ...
  return (
    <>
      <Helmet>
        ...
        <title>Barbershop Berlin | Barber shop 030</title>
        <meta
          name="description"
          content="Besuche unseren Premium Barbershop Barber shop 030 in Berlin für erstklassige Haarschnitte, Bartpflege und individuelle Styles. Jetzt Termin buchen!"
        />
        <meta
          name="keywords"
        ...
        {/* Open Graph */}
        <meta property="og:title" content="Barber shop 030 | Premium Barbershop Berlin" />
        <meta
        ...
        <meta name="twitter:title" content="Barber shop 030 | Premium Barbershop Berlin" />
        <meta
